...
NAME_MAP = {
    ...
    "limit_absolute":       "Limit absolut (W)",
    "data_age":             "Datenalter",
    ...
    "hints_pin_mapping_issue":  "Pin-Mapping Problem",
}
...
def classify(key, unit, is_bool=False):
    ...
    if is_bool:
        ...
        if "reactivepower" in key_l:
            # Muss VOR "power" stehen, da "reactivepower" auch "power" enthält!
            device_class = SensorDeviceClass.REACTIVE_POWER
            state_class = SensorStateClass.MEASUREMENT
        elif "power" in key_l and "factor" not in key_l:
